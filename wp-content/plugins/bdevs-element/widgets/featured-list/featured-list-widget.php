...
class Featured_List extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'starting from', 'bdevselement' ),
    ...
    protected function render() {
        ...
        ?>
        <section class="features__area wow fadeInUp2 d-none" data-wow-delay=".5s">
            <div class="container">
        ...
        <section class="catagory-area black-bg pt-100">
            <div class="container">
                <div class="row">
                    <?php foreach ( $settings['slides'] as $slide ):
                        if ( !empty($slide['image']['id']) ) {
                    ...
                    <div class="col-lg-6">
                        <div class="cat-main-wrap">
                            ...
                            <span class="back-text3 d-none d-lg-block"><?php echo bdevs_element_kses_basic( $slide['back-title'] ); ?></span>
                            <?php endif; ?>
                            <div class="catagory-wrapper mb-30">
                                <div class="catogory-content">
                                    <div class="catogory-price">
                                        <?php if ( !empty($slide['sub-title']) ) : ?>
                                        <span><?php echo bdevs_element_kses_basic( $slide['sub-title'] ); ?></span>
                                        <?php endif; ?>

                                        <?php if ( !empty($slide['price']) ) : ?>
                                        <span class="cat-price"><?php echo bdevs_element_kses_basic( $slide['price'] ); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="catagory-hed-box">
                                        <?php if ( !empty($slide['title']) ) : ?>
                                        <h4 class="cat-title"><?php echo bdevs_element_kses_basic( $slide['title'] ); ?></h4>
                                        <?php endif; ?>

                                        <?php if ( !empty($slide['button_text']) ) : ?>
                                        <div class="cat-btn">
                                            <a href="<?php echo esc_url( $slide['button_link'] ); ?>"><?php echo bdevs_element_kses_basic( $slide['button_text'] ); ?></a>
                                        </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="catagory-thumb">
                                        <img src="<?php print esc_url($image); ?>" alt="<?php print esc_attr__('image','bombo'); ?>">
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
