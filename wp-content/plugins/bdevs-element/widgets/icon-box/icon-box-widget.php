...
class Icon_Box extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __( 'URL', 'bdevselement' ),
                'dynamic'     => [
                    'active' => true,
                ],
            ]
    ...
    protected function render() {
        ...
        <?php elseif ( $settings['design_style'] === 'style_3' ):
            ...
            $this->add_inline_editing_attributes( 'title', 'basic' );
            $this->add_render_attribute( 'title', 'class', 'afeature__text--title' );
        ?>

        <div class="afeature text-center mb-30 wow fadeInUp2" data-wow-delay=".3s">
            <div class="afeature__icon choose--afeature__icon mb-35">
                <?php if ( $settings['type'] === 'image' && ( $settings['image']['url'] || $settings['image']['id'] ) ):
                    $this->get_render_attribute_string( 'image' );
                    $settings['hover_animation'] = 'disable-animation'; // hack to prevent image hover animation
                    ?>
            ...
            <div class="afeature__text">
                ...
                <?php if ( $settings['description'] ): ?>
                    <p class="p-0"><?php echo esc_html( $settings['description'] ); ?></p>
                <?php endif;?>
            </div>
        </div>
        ...
        ?>
        <div class="afeature text-center mb-30 wow fadeInUp2"  data-wow-delay=".3s">
            <div class="afeature__icon service--afeature__icon mb-35">
                <?php if ( $settings['type'] === 'image' && ( $settings['image']['url'] || $settings['image']['id'] ) ):
                    $this->get_render_attribute_string( 'image' );
                    $settings['hover_animation'] = 'disable-animation'; // hack to prevent image hover animation
                    ?>
