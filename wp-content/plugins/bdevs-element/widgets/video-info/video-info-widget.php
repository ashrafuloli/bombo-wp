...
class Video_Info extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'default' => __( 'bdevs info box Sub Title goes here', 'bdevselement' ),
    ...
    <?php if ($settings['design_style'] === 'style_2'):
        ...
        <div class="video-area project-description-video mb-25">
            <div class="avideo__text avideo__text--3 text-center">
                <?php if ( !empty($settings['video_url']) ) : ?>
                <div class="avideo-btn play_btn mb-45">
                    <a class="venobox" data-autoplay="true" data-vbtype="video" href="<?php echo esc_url( $settings['video_url'] ); ?>">
    ...
    <?php else:
        ...
        $this->add_inline_editing_attributes( 'title', 'basic' );
        $this->add_render_attribute( 'title', 'class', 'play-video' );
