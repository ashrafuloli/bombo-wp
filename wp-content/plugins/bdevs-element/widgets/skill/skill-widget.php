...
class Skill extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control(
            'skill_bg_color',
            [
                'label' => __( 'Skill Bg color', 'bdevselement' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#FEC931',
                'frontend_available' => true,
                'selectors' => [
	...
	protected function render() {
        ...
        <section class="skill-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <?php if ( !empty($image) ) : ?>
                        <div class="skill__img mb-30 wow fadeInUp2" data-wow-delay=".3s">
                            <img src="<?php echo esc_url($image); ?>" alt="<?php print esc_attr__('image','airvice'); ?>">
                        </div>
                        <?php endif ?>
                    </div>
                    <div class="col-lg-6">
                        <div class="skill--main mb-30 wow fadeInUp2" data-wow-delay=".6s">
                            ...
                            <div class="skill--content">
                                ...
                                <div class="skill__wrapper mb-35">
                                    <div class="skill--title__wrapper">
                                        <h5 class="skill--title"><?php echo esc_html( $slide['title'] ); ?></h5>
                                        <span><?php echo esc_html( $slide['number'] ); ?></span>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar theme-bg wow slideInLeft elementor-repeater-item-<?php echo esc_attr($slide['_id']); ?>" data-wow-duration="1s" data-wow-delay="0.5s" role="progressbar" style="width: <?php echo esc_attr( $slide['number'] ); ?>; visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: slideInLeft;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <?php endforeach; ?>
                            </div>
        ...
        <div class="skill--main mb-40 wow fadeInUp2" data-wow-delay="1.5s">
            <div class="skill--content">
                <?php foreach ( $settings['slides'] as $slide ) :?>
                <div class="skill__wrapper mb-25 ">
                    <div class="skill--title__wrapper">
                        <h5 class="skill--title"><?php echo esc_html( $slide['title'] ); ?></h5>
                        <span><?php echo esc_html( $slide['number'] ); ?></span>
                    </div>
                    <div class="progress">
                        <div class="progress-bar theme-bg wow slideInLeft elementor-repeater-item-<?php echo esc_attr($slide['_id']); ?>" data-wow-duration="1s" data-wow-delay="0.5s" role="progressbar" style="width: <?php echo esc_attr( $slide['number'] ); ?>; " aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
