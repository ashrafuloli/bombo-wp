...
class Pricing_Table extends BDevs_El_Widget
{
    ...
    <?php else:
        ...
        $this->add_inline_editing_attributes('button_footer', 'none');
        $this->add_render_attribute('button_footer', 'class', 'theme-btn grey-btn bdevs-btn');
        $this->add_link_attributes('button_footer', $settings['button_link']);
        ?>

        <div class="price__item white-bg mb-30 transition-3 fix d-none <?php print esc_attr($class_name); ?>">
            <?php if ($settings['title']) : ?>
            <div class="price__offer mb-15">
               <span><?php echo bdevs_element_kses_basic($settings['title']); ?></span>
            </div>
            <?php endif; ?>
            ...
            <div class="price__tag mb-15">
               <h3><?php echo esc_html($currency); ?><?php echo bdevs_element_kses_basic($settings['price']); ?> 
                    <?php if ($settings['period']) : ?><span><?php echo bdevs_element_kses_basic($settings['period']); ?></span>
                    <?php endif; ?>
                </h3>
            </div>
            <?php endif; ?>
        ...
        <div class="aprice-bg wow flipInY <?php print esc_attr($class_name); ?>" data-wow-delay=".6s">
            <div class="aprice mb-45">
                <div class="aprice__icon--wrapper mb-30">
                <?php if (!empty($settings['image']['id']) && $settings['type'] === 'image') : ?>
                    <div class="aprice__icon">
                         <?php echo Group_Control_Image_Size::get_attachment_image_html($settings, 'thumbnail', 'image'); ?>
                    </div>
                <?php else: ?>
                    <div class="aprice__icon">
                ...
                <?php endif; ?>
                    <div class="aprice__icon--text">
                        <?php if ($settings['title']) : ?>
                        <span><?php echo bdevs_element_kses_basic($settings['title']); ?></span>
                        <?php endif; ?>
                        <?php if ($settings['sub_title']) : ?>
                        <h4><?php echo bdevs_element_kses_basic($settings['sub_title']); ?></h4>
                        <?php endif; ?>
                    </div>
                </div>
                <?php if ($settings['price']) : ?>
                <div class="aprice__price--wrapper">
                    <h2><?php echo esc_html($currency); ?><?php echo bdevs_element_kses_basic($settings['price']); ?> 
                    <?php if ($settings['period']) : ?><span><?php echo bdevs_element_kses_basic($settings['period']); ?></span>
                    <?php endif; ?>
                    </h2>
                </div>
                <?php endif; ?>
                <div class="aprice__list">
                    <ul>
                        <?php foreach ($settings['features_list'] as $index => $feature) :
                            $name_key = $this->get_repeater_setting_key('text', 'features_list', $index);
                            $this->add_inline_editing_attributes($name_key, 'intermediate');
                ...
                <?php if ($settings['button_text']) : ?>
                <div class="aprice-btn text-center">
                    <a <?php $this->print_render_attribute_string('button_footer'); ?>>
