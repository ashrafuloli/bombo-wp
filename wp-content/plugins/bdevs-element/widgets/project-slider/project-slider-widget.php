            ...
            <div class="gallery-active swiper-container common-dots pb-45">
                <div class="swiper-wrapper wow fadeInUp2" data-wow-delay=".6s">
                    ...
                    <div class="aportfolio agallery swiper-slide mb-30">
                        ...
                        <div class="aportfolio__text agallery__text z-index">
                            <?php if (!empty($slide['sub_title'])) : ?>
                            <span><?php echo bdevs_element_kses_basic($slide['sub_title']); ?></span>
                            <?php endif; ?>
                            <?php if (!empty($slide['title'])) : ?>
                            <h4 class="aportfolio__text--title"><a href="<?php echo esc_url($slide['slide_url']); ?>"><?php echo bdevs_element_kses_basic($slide['title']); ?></a></h4>
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php endforeach; ?>
