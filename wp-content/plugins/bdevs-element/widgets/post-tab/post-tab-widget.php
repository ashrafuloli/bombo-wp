    ...
    protected function render () {
        ...
        <section class="portfolio-area">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="aportfolio-menu aportfolio-menu-inner text-center mb-40 wow fadeInUp2"  data-wow-delay=".6s">
                ...
                <div class="row aportfolio-active">
                    ...
                    ?>
                    <div class="col-xl-4 col-md-6 grid-item <?php echo $item_classes; ?>">
                        <div class="aportfolio mb-40 wow fadeInUp2"  data-wow-delay=".3s">
                            <div class="aportfolio__img">
                                <?php if ( has_post_thumbnail() ): ?>
                                <img src="<?php echo get_the_post_thumbnail_url(); ?>" class="img-fluid" alt="img">
                                <?php endif;?>
                                
                                <div class="aportfolio__img--icon">
                                    <a class="popup-image" data-gall="gallery01" href="<?php echo get_the_post_thumbnail_url(); ?>">
                            ...
                            <div class="aportfolio__text aportfolio__inner--text z-index">
                                ...
                                <h4 class="aportfolio__text--title"><a href="<?php echo esc_url( get_the_permalink() ); ?>"><?php the_title(); ?></a></h4>
                            </div>
                        </div>
                    </div>
                    <?php endwhile; 
        ...
        <section class="portfolio-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title-wrapper mb-70 wow fadeInUp2" data-wow-delay=".3s">
                    ...
                    <div class="col-lg-6">
                        <div class="aportfolio-menu text-end wow fadeInUp2" data-wow-delay=".6s">
                            <div class="masonary-menu filter-button-group">
                                <?php foreach ( $filter_list as $list ): ?>
                                    <?php if ( $i === 1 ): $i++; ?>
                                    <button class="active" data-filter="*"><?php echo esc_html( 'All' ); ?></button>
