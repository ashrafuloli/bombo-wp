...
<div class="col-lg-6 col-md-6 grid-item">
    <article class="postbox post format-image mb-40">
        ...
        if(!empty( $massonary_img_id )): ?>
            <div class="postbox__thumb mb-25">
                <a href="<?php the_permalink(); ?>">
                    <img src="<?php print esc_url( $massonary_img ); ?>" alt="<?php print airvice_img_alt_text($massonary_img_id); ?>">
                </a>
            </div>
        <?php 
        endif; ?>
        ...
        <div class="postbox__text">
            ...
            <!-- blog btn -->
            <?php 
                $airvice_blog_btn     = get_theme_mod('airvice_blog_btn','Read More text'); 
                $airvice_blog_btn_icon     = get_theme_mod('airvice_blog_btn_icon','far fa-long-arrow-right'); 
                $airvice_blog_btn_switch     = get_theme_mod('airvice_blog_btn_switch'); 
                $airvice_blog_btn_icon_switch     = get_theme_mod('airvice_blog_btn_icon_switch'); 

            if( $airvice_blog_btn_switch ): ?>
            <div class="read-more-btn">
                <a href="<?php the_permalink(); ?>" class="read-more"><?php print esc_html($airvice_blog_btn); ?> <i class="fas fa-long-arrow-alt-right"></i></a>
            </div>
            <?php 
            endif; ?>
