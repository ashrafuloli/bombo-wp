...
class Customizer_Class {
	...
	public function __construct($data) {
		$this->data = $data;
		add_action('customize_register',array($this,'airvice_customize_register'));
	...
	public function airvice_customize_register($customizeObj) {
		...
		public function render_content() {
			...
			<label>
				...
				<div class="switch_options">
					<span class="switch_enable"><?php esc_html_e('Show','airvice'); ?></span>
					<span class="switch_disable"><?php esc_html_e('Hide','airvice'); ?></span>  
